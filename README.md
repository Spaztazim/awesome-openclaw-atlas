?
- [aiming-lab/MetaClaw](https://github.com/aiming-lab/metaclaw) - Self-evolving agent wrapper. Proxy interception, judge LLM scoring, auto-skill generation, LoRA fine-tuning. ? 1.1K# awesome-openclaw-ecosystem
...
- [aiming-lab/MetaClaw](https://github.com/aiming-lab/metaclaw) - Self-evolving agent wrapper. Proxy interception, judge LLM scoring, auto-skill generation, LoRA fine-tuning. ? 1.1K

## GUI & Dashboards

Visual interfaces and management tools for OpenClaw.

- [daggerhashimoto/openclaw-nerve](https://github.com/daggerhashimoto/openclaw-nerve) - Real-time web cockpit for OpenClaw. Voice conversations, agent kanban board, workspace control, sub-agent sessions, inline charts. $([char]0x2B50) 557
...
- [msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents) - Complete AI agency at your fingertips. ? 46K+
- [Dekelelz/let-them-talk](https://github.com/Dekelelz/let-them-talk) - MCP message broker for multi-agent CLI collaboration. 3D virtual office, proactive work loops. BSL 1.1 license.
