...
- [AtlasGeisler/acan-salience-v2](https://github.com/AtlasGeisler/acan-salience-v2) - Six-factor memory scoring library for agent context. Standalone Python, no pipeline integration required.
